		...
		<section className='section1'>
			<div className='boxes'>
				<div className='description box'>
					<div className='description_M-Store'>
						...
						<p className='description_M-Store_p'>
							M-Store, disfruta de los mejores productos a solo un clic de
							distancia.
						</p>
					</div>
				...
				<div className='about box'>
					...
					<nav className='about_nav nav'>
						<a href='#' className='about_nav_a a'>
							Acerca de M-Store
						</a>
						<a href='#' className='about_nav_a a'>
							Noticias
				...
				<div className='service box'>
					...
					<nav className='service_nav nav'>
						<a href='#' className='service_nav_a a'>
			...
			<div className='author'>
				...
				<span className='author_span'>
					Diseñado por Vicente Jorquera. Desarrollado por
					<a href='https://vicente-jorquera.netlify.app' className='a'>
						{' '}
						Vicente Jorquera,
					</a>
					<a href='www.linkedin.com/in/catalina-zapata' className='a'>
						{' '}
						Catalina Zapata,
					</a>
					<a href='#' className='a'>
